...
function setTimezoneTiles(loc, locNY, locChi, locH) {
    ...
    var apicall3 = 'https://maps.googleapis.com/maps/api/timezone/json?location=' + locChi + '&timestamp=' + timestamp + '&key=' + apikey
    ...
    callApiAndUpdateText(apicall3, "timezoneChicago", timestamp);
